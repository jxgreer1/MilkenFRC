...
public final class Constants {
  ...
  public static class SHOOTER {
    ...
    public static final double kFlywheelKp = 0.0016; //.0016 bigger is better also dont change it dud
    ...
    public static final double kMaxHoodPos = -3.20;
  ...
  public static class VISION {
    ...
    public static final double kP_turn = 0.005;     //0.01205;
    public static final double kI_turn = 0.0;
    public static final double kD_turn = 0;             //0.0033;
